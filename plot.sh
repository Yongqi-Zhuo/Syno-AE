...
python analysis/plot-models.py \
 ...
 --mdev-path $SCRIPT_PATH/exp_data/vision/mdev/good-kernels-imagenet\
 --a100-path $SCRIPT_PATH/exp_data/vision/a100/good-kernels-imagenet\
...
python analysis/layerwise.py --output $OUTPUT_DIR\
 ...
 --baseline-latency-folder-mdev $SCRIPT_PATH/exp_data/vision/mdev/baseline-latency\
 --baseline-latency-folder-a100 $SCRIPT_PATH/exp_data/vision/a100/baseline-latency\
 --mdev-nas-pte-path $SCRIPT_PATH/exp_data/vision/mdev/nas-pte\
 --a100-nas-pte-path $SCRIPT_PATH/exp_data/vision/a100/nas-pte
