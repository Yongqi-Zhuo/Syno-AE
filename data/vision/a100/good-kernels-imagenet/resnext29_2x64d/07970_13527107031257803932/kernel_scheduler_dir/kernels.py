...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x5621811c9bb8 [label="H", shape=none];
        interface_2_in_0x7fd0e400cde0 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_2_in_0x5621811c9bb8;
        interface_2_in_0x7fd0e400cde0;
    ...
    op_0x7fd268007500 -> interface_2_out_0x5621811c9b90 [label="H"];
    interface_2_in_0x5621811c9bb8 -> interface_2_out_0x5621811c9bb8 [label="H"];
    interface_2_in_0x7fd0e400cde0 -> interface_2_out_0x7fd0e400cde0 [label="k_1"];
    interface_2_in_0x7fd268007528 -> op_0x7fd268007500 [label="H"];
    op_0x7fd268007500 -> interface_2_out_0x7fd5e00045d0 [label="k_1"];
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_out {
        ...
        interface_3_out_0x5621811c9bb8 [label="H", shape=none];
        interface_3_out_0x7fd0e400cde0 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_3_out_0x5621811c9bb8;
        interface_3_out_0x7fd0e400cde0;
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x7fd268007528 [label="H", shape=none];
        interface_3_in_0x5621811c9bb8 [label="H", shape=none];
        interface_3_in_0x7fd0380547a0 [label="k_1", shape=none];
    }
    // Input 1.
    subgraph cluster_subgraph_3_in_1 {
        label = "";
        interface_3_in_0x7fd4a4232ff8 [label="g*s", shape=none];
        interface_3_in_0x7fd0380547b8 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_3_in_0x7fd268007528;
        interface_3_in_0x5621811c9bb8;
        interface_3_in_0x7fd0380547a0;
        interface_3_in_0x7fd4a4232ff8;
        interface_3_in_0x7fd0380547b8;
    ...
    interface_3_in_0x5621811c9bb8 -> interface_3_out_0x5621811c9bb8 [label="H"];
    ...
    interface_3_in_0x7fd0380547a0 -> op_0x7fd038054780 [label="k_1"];
    interface_3_in_0x7fd0380547b8 -> op_0x7fd038054780 [label="k_1"];
    op_0x7fd038054780 -> interface_3_out_0x7fd0e400cde0 [label="k_1"];
    interface_3_in_0x7fd268007528 -> interface_3_out_0x7fd268007528 [label="H"];
...
subgraph cluster_subgraph_4 {
    ...
    subgraph cluster_subgraph_4_out {
        ...
        interface_4_out_0x7fd268007528 [label="H", shape=none];
        interface_4_out_0x5621811c9bb8 [label="H", shape=none];
        interface_4_out_0x7fd0380547a0 [label="k_1", shape=none];
    }
    {
        rank = same;
        ...
        interface_4_out_0x7fd268007528;
        interface_4_out_0x5621811c9bb8;
        interface_4_out_0x7fd0380547a0;
    }
    // Input 0.
    subgraph cluster_subgraph_4_in_0 {
        ...
        interface_4_in_0x7fd268007528 [label="H", shape=none];
        interface_4_in_0x7fd228054568 [label="H", shape=none];
    }
    {
        rank = same;
        interface_4_in_0x5621811c9b40;
        interface_4_in_0x7fc3d03afa80;
        interface_4_in_0x7fd268007528;
        interface_4_in_0x7fd228054568;
    }
    // Op's.
    ...
    op_0x7fd228054540 -> interface_4_out_0x5621811c9bb8 [label="H"];
    interface_4_in_0x7fc3d03afa80 -> op_0x7fc3d03afa40 [label="C_in"];
    op_0x7fd228054540 -> interface_4_out_0x7fd0380547a0 [label="k_1"];
    interface_4_in_0x7fd228054568 -> op_0x7fd228054540 [label="H"];
    interface_4_in_0x7fd268007528 -> interface_4_out_0x7fd268007528 [label="H"];
...
subgraph cluster_subgraph_5 {
    ...
    interface_5_out_0x7fd268007528 [label="H", shape=none];
    interface_5_out_0x7fd228054568 [label="H", shape=none];
}

interface_5_out_0x5621811c9b40 -> interface_4_in_0x5621811c9b40;
interface_5_out_0x7fc3d03afa80 -> interface_4_in_0x7fc3d03afa80;
interface_5_out_0x7fd268007528 -> interface_4_in_0x7fd268007528;
interface_5_out_0x7fd228054568 -> interface_4_in_0x7fd228054568;
...
interface_4_out_0x7fd268007528 -> interface_3_in_0x7fd268007528;
interface_4_out_0x5621811c9bb8 -> interface_3_in_0x5621811c9bb8;
interface_4_out_0x7fd0380547a0 -> interface_3_in_0x7fd0380547a0;

// Input tensor.
subgraph cluster_subgraph_6 {
    label = "Input 2";
    interface_6_out_0x7fd4a4232ff8 [label="g*s", shape=none];
    interface_6_out_0x7fd0380547b8 [label="k_1", shape=none];
    interface_6_out_0x7fd038054268 [label="g^-1*C_out", shape=none];
}

interface_6_out_0x7fd4a4232ff8 -> interface_3_in_0x7fd4a4232ff8;
interface_6_out_0x7fd0380547b8 -> interface_3_in_0x7fd0380547b8;
...
interface_3_out_0x5621811c9bb8 -> interface_2_in_0x5621811c9bb8;
interface_3_out_0x7fd0e400cde0 -> interface_2_in_0x7fd0e400cde0;
...

{
    ...
    interface_5_out_0x7fd268007528;
    interface_5_out_0x7fd228054568;
    ...
    interface_6_out_0x7fd0380547b8;
...
class kernel_generated_0(torch.nn.Module):
	...
	def forward(self, x):
		...
		t_3 = torch.reshape(t_3, (128, 7168, 56, 1, ))
		t_3 = torch.nn.functional.unfold(t_3, (3, 1, ), padding=(1, 0, ))
		t_3 = torch.reshape(t_3, (128, 64, 2, 56, 3, 56, ))

		# Permute to match the output of this subgraph.
		t_3 = torch.permute(t_3, (0, 1, 2, 3, 5, 4, ))

		# Perform contraction.
		t_4 = torch.einsum("lkonmj, kji -> lonmji", t_3, in_2)

		# No contraction needed.
		t_5 = t_4

		# [H]@Unfold4d77c1e3da5bca44 -> [H]@Iterator96123ba3184da39c, [k_1]@Share26cfa48d169008e4
		t_5 = torch.reshape(t_5, (128, 2, 56, 672, ))
		t_5 = torch.nn.functional.unfold(t_5, (3, 1, ), padding=(1, 0, ))
		t_5 = torch.reshape(t_5, (128, 2, 3, 56, 56, 3, 4, ))

		# Permute to match the output of this subgraph.
		t_5 = torch.permute(t_5, (0, 1, 3, 2, 4, 5, 6, ))

		# Perform contraction.
		t_6 = torch.einsum("mlnkoip, lkij -> mnopj", t_5, in_1)
...
class kernel_generated_1(torch.nn.Module):
	...
	def forward(self, x):
		...
		# [H]@Unfold90ae9d8acef524e0 -> [H]@Iteratorb0a1def4ad5784ec, [k_1]@Share63a88e0da5dce9dc
		t_3 = torch.reshape(t_3, (128, 7168, 28, 1, ))
		t_3 = torch.nn.functional.unfold(t_3, (3, 1, ), padding=(1, 0, ))
		t_3 = torch.reshape(t_3, (128, 64, 4, 28, 3, 28, ))
		...
		# [H]@Unfold4d77c1e3da5bca44 -> [H]@Iterator96123ba3184da39c, [k_1]@Share26cfa48d169008e4
		t_5 = torch.reshape(t_5, (128, 4, 28, 672, ))
		t_5 = torch.nn.functional.unfold(t_5, (3, 1, ), padding=(1, 0, ))
		t_5 = torch.reshape(t_5, (128, 4, 3, 28, 28, 3, 8, ))
...
class kernel_generated_2(torch.nn.Module):
	...
	def forward(self, x):
		...
		# [H]@Unfold90ae9d8acef524e0 -> [H]@Iteratorb0a1def4ad5784ec, [k_1]@Share63a88e0da5dce9dc
		t_3 = torch.reshape(t_3, (128, 7168, 14, 1, ))
		t_3 = torch.nn.functional.unfold(t_3, (3, 1, ), padding=(1, 0, ))
		t_3 = torch.reshape(t_3, (128, 64, 8, 14, 3, 14, ))
		...
		# [H]@Unfold4d77c1e3da5bca44 -> [H]@Iterator96123ba3184da39c, [k_1]@Share26cfa48d169008e4
		t_5 = torch.reshape(t_5, (128, 8, 14, 672, ))
		t_5 = torch.nn.functional.unfold(t_5, (3, 1, ), padding=(1, 0, ))
		t_5 = torch.reshape(t_5, (128, 8, 3, 14, 14, 3, 16, ))
...
class kernel_generated_3(torch.nn.Module):
	...
	def forward(self, x):
		...
		# [H]@Unfold90ae9d8acef524e0 -> [H]@Iteratorb0a1def4ad5784ec, [k_1]@Share63a88e0da5dce9dc
		t_3 = torch.reshape(t_3, (128, 7168, 7, 1, ))
		t_3 = torch.nn.functional.unfold(t_3, (3, 1, ), padding=(1, 0, ))
		t_3 = torch.reshape(t_3, (128, 64, 16, 7, 3, 7, ))
		...
		# [H]@Unfold4d77c1e3da5bca44 -> [H]@Iterator96123ba3184da39c, [k_1]@Share26cfa48d169008e4
		t_5 = torch.reshape(t_5, (128, 16, 7, 672, ))
		t_5 = torch.nn.functional.unfold(t_5, (3, 1, ), padding=(1, 0, ))
		t_5 = torch.reshape(t_5, (128, 16, 3, 7, 7, 3, 32, ))
