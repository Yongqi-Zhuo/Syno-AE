...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x55b7501b62e0 [label="k_1", shape=none];
        interface_2_in_0x55b7386312f8 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_2_in_0x55b7501b62e0;
        interface_2_in_0x55b7386312f8;
    }
    // Op's.
    op_0x55b7501d4640 [label="Unfold"];
    // Dimension's.
    interface_2_in_0x55b738631280 -> interface_2_out_0x55b738631280 [label="N"];
    op_0x55b7501d4640 -> interface_2_out_0x55b7386312d0 [label="H"];
    interface_2_in_0x55b7386312f8 -> interface_2_out_0x55b7386312f8 [label="H"];
    interface_2_in_0x55b7501b61f0 -> interface_2_out_0x55b7501b61f0 [label="g^-1*s^-1*C_in"];
    op_0x55b7501d4640 -> interface_2_out_0x55b7501b6290 [label="k_1"];
    interface_2_in_0x55b7501b62e0 -> interface_2_out_0x55b7501b62e0 [label="k_1"];
    interface_2_in_0x55b7501bae98 -> interface_2_out_0x55b7501bae98 [label="g^-1*C_out"];
    interface_2_in_0x55b7501d4668 -> op_0x55b7501d4640 [label="H"];
}
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_out {
        ...
        interface_3_out_0x55b7501b62e0 [label="k_1", shape=none];
        interface_3_out_0x55b7386312f8 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_3_out_0x55b7501b62e0;
        interface_3_out_0x55b7386312f8;
    }
    // Input 0.
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x55b7501d4668 [label="H", shape=none];
        interface_3_in_0x55b7501b6510 [label="k_1", shape=none];
        interface_3_in_0x55b7386312f8 [label="H", shape=none];
    }
    // Input 1.
    subgraph cluster_subgraph_3_in_1 {
        ...
        interface_3_in_0x55b7501b6528 [label="k_1", shape=none];
    }
    {
        rank = same;
        ...
        interface_3_in_0x55b7501d4668;
        interface_3_in_0x55b7501b6510;
        interface_3_in_0x55b7386312f8;
        interface_3_in_0x55b7501b6578;
        interface_3_in_0x55b7501b65c8;
        interface_3_in_0x55b7501b6528;
    }
    // Op's.
    ...
    interface_3_in_0x55b7386312f8 -> interface_3_out_0x55b7386312f8 [label="H"];
    interface_3_in_0x55b7501b61f0 -> interface_3_out_0x55b7501b61f0 [label="g^-1*s^-1*C_in"];
    op_0x55b7501b64f0 -> interface_3_out_0x55b7501b62e0 [label="k_1"];
    interface_3_in_0x55b7501b6510 -> op_0x55b7501b64f0 [label="k_1"];
    interface_3_in_0x55b7501b6528 -> op_0x55b7501b64f0 [label="k_1"];
    ...
    interface_3_in_0x55b7501d4668 -> interface_3_out_0x55b7501d4668 [label="H"];
...
subgraph cluster_subgraph_4 {
    ...
    subgraph cluster_subgraph_4_out {
        ...
        interface_4_out_0x55b7501d4668 [label="H", shape=none];
        interface_4_out_0x55b7501b6510 [label="k_1", shape=none];
        interface_4_out_0x55b7386312f8 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_4_out_0x55b7501d4668;
        interface_4_out_0x55b7501b6510;
        interface_4_out_0x55b7386312f8;
    }
    // Input 0.
    subgraph cluster_subgraph_4_in_0 {
        ...
        interface_4_in_0x55b7501d4668 [label="H", shape=none];
        interface_4_in_0x55b7501d46e8 [label="H", shape=none];
    }
    {
        rank = same;
        interface_4_in_0x55b738631280;
        interface_4_in_0x55b7501f3de0;
        interface_4_in_0x55b7501d4668;
        interface_4_in_0x55b7501d46e8;
    }
    // Op's.
    ...
    op_0x55b7501d46c0 -> interface_4_out_0x55b7386312f8 [label="H"];
    op_0x55b7501f3da0 -> interface_4_out_0x55b7501b61f0 [label="g^-1*s^-1*C_in"];
    op_0x55b7501d46c0 -> interface_4_out_0x55b7501b6510 [label="k_1"];
    op_0x55b7501f3da0 -> interface_4_out_0x55b7501b65b0 [label="g*s"];
    interface_4_in_0x55b7501d4668 -> interface_4_out_0x55b7501d4668 [label="H"];
    interface_4_in_0x55b7501d46e8 -> op_0x55b7501d46c0 [label="H"];
...
subgraph cluster_subgraph_5 {
    ...
    interface_5_out_0x55b7501d4668 [label="H", shape=none];
    interface_5_out_0x55b7501d46e8 [label="H", shape=none];
}

interface_5_out_0x55b738631280 -> interface_4_in_0x55b738631280;
interface_5_out_0x55b7501f3de0 -> interface_4_in_0x55b7501f3de0;
interface_5_out_0x55b7501d4668 -> interface_4_in_0x55b7501d4668;
interface_5_out_0x55b7501d46e8 -> interface_4_in_0x55b7501d46e8;
...
interface_4_out_0x55b7501d4668 -> interface_3_in_0x55b7501d4668;
interface_4_out_0x55b7501b6510 -> interface_3_in_0x55b7501b6510;
interface_4_out_0x55b7386312f8 -> interface_3_in_0x55b7386312f8;
...
interface_3_out_0x55b7501b62e0 -> interface_2_in_0x55b7501b62e0;
interface_3_out_0x55b7386312f8 -> interface_2_in_0x55b7386312f8;
...

{
    ...
    interface_5_out_0x55b7501d4668;
    interface_5_out_0x55b7501d46e8;
    ...
    interface_6_out_0x55b7501b6528;
}
