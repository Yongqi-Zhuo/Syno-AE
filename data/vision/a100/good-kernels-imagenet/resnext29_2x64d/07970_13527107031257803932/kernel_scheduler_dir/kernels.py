...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x55ceeec91828 [label="H", shape=none];
        interface_2_in_0x55ceeec82dd0 [label="k_1", shape=none];
        interface_2_in_0x55ceeb214998 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_2_in_0x55ceeec91828;
        interface_2_in_0x55ceeec82dd0;
        interface_2_in_0x55ceeb214998;
    }
    // Op's.
    op_0x55ceeec91800 [label="Unfold"];
    // Dimension's.
    interface_2_in_0x55ceeb214920 -> interface_2_out_0x55ceeb214920 [label="N"];
    op_0x55ceeec91800 -> interface_2_out_0x55ceeb214970 [label="H"];
    interface_2_in_0x55ceeb214998 -> interface_2_out_0x55ceeb214998 [label="H"];
    op_0x55ceeec91800 -> interface_2_out_0x55ceeec82c40 [label="k_1"];
    interface_2_in_0x55ceeec82d30 -> interface_2_out_0x55ceeec82d30 [label="g^-1*s^-1*C_in"];
    interface_2_in_0x55ceeec82dd0 -> interface_2_out_0x55ceeec82dd0 [label="k_1"];
    interface_2_in_0x55ceeec84ff8 -> interface_2_out_0x55ceeec84ff8 [label="g^-1*C_out"];
    interface_2_in_0x55ceeec91828 -> op_0x55ceeec91800 [label="H"];
}
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_out {
        ...
        interface_3_out_0x55ceeec91828 [label="H", shape=none];
        interface_3_out_0x55ceeec82dd0 [label="k_1", shape=none];
        interface_3_out_0x55ceeb214998 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_3_out_0x55ceeec91828;
        interface_3_out_0x55ceeec82dd0;
        interface_3_out_0x55ceeb214998;
    }
    // Input 0.
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x55ceeec91828 [label="H", shape=none];
        interface_3_in_0x55ceeec82fb0 [label="k_1", shape=none];
        interface_3_in_0x55ceeb214998 [label="H", shape=none];
    }
    // Input 1.
    subgraph cluster_subgraph_3_in_1 {
        ...
        interface_3_in_0x55ceeec82fc8 [label="k_1", shape=none];
    }
    {
        rank = same;
        ...
        interface_3_in_0x55ceeec91828;
        interface_3_in_0x55ceeec82fb0;
        interface_3_in_0x55ceeb214998;
        interface_3_in_0x55ceeec82ed8;
        interface_3_in_0x55ceeec82f28;
        interface_3_in_0x55ceeec82fc8;
    }
    // Op's.
    ...
    interface_3_in_0x55ceeb214998 -> interface_3_out_0x55ceeb214998 [label="H"];
    interface_3_in_0x55ceeec82d30 -> interface_3_out_0x55ceeec82d30 [label="g^-1*s^-1*C_in"];
    op_0x55ceeec82f90 -> interface_3_out_0x55ceeec82dd0 [label="k_1"];
    ...
    interface_3_in_0x55ceeec82fb0 -> op_0x55ceeec82f90 [label="k_1"];
    interface_3_in_0x55ceeec82fc8 -> op_0x55ceeec82f90 [label="k_1"];
    op_0x55ceeec82ea0 -> interface_3_out_0x55ceeec84ff8 [label="g^-1*C_out"];
    interface_3_in_0x55ceeec91828 -> interface_3_out_0x55ceeec91828 [label="H"];
...
subgraph cluster_subgraph_4 {
    ...
    subgraph cluster_subgraph_4_out {
        ...
        interface_4_out_0x55ceeec91828 [label="H", shape=none];
        interface_4_out_0x55ceeec82fb0 [label="k_1", shape=none];
        interface_4_out_0x55ceeb214998 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_4_out_0x55ceeec91828;
        interface_4_out_0x55ceeec82fb0;
        interface_4_out_0x55ceeb214998;
    }
    // Input 0.
    subgraph cluster_subgraph_4_in_0 {
        ...
        interface_4_in_0x55ceeec91828 [label="H", shape=none];
        interface_4_in_0x55ceeec918a8 [label="H", shape=none];
    }
    {
        rank = same;
        interface_4_in_0x55ceeb214920;
        interface_4_in_0x55ceeecc1190;
        interface_4_in_0x55ceeec91828;
        interface_4_in_0x55ceeec918a8;
    }
    // Op's.
    ...
    op_0x55ceeec91880 -> interface_4_out_0x55ceeb214998 [label="H"];
    ...
    op_0x55ceeec91880 -> interface_4_out_0x55ceeec82fb0 [label="k_1"];
    interface_4_in_0x55ceeec91828 -> interface_4_out_0x55ceeec91828 [label="H"];
    interface_4_in_0x55ceeec918a8 -> op_0x55ceeec91880 [label="H"];
...
subgraph cluster_subgraph_5 {
    ...
    interface_5_out_0x55ceeec91828 [label="H", shape=none];
    interface_5_out_0x55ceeec918a8 [label="H", shape=none];
}

interface_5_out_0x55ceeb214920 -> interface_4_in_0x55ceeb214920;
interface_5_out_0x55ceeecc1190 -> interface_4_in_0x55ceeecc1190;
interface_5_out_0x55ceeec91828 -> interface_4_in_0x55ceeec91828;
interface_5_out_0x55ceeec918a8 -> interface_4_in_0x55ceeec918a8;
...
interface_4_out_0x55ceeec91828 -> interface_3_in_0x55ceeec91828;
interface_4_out_0x55ceeec82fb0 -> interface_3_in_0x55ceeec82fb0;
interface_4_out_0x55ceeb214998 -> interface_3_in_0x55ceeb214998;
...
interface_3_out_0x55ceeec91828 -> interface_2_in_0x55ceeec91828;
interface_3_out_0x55ceeec82dd0 -> interface_2_in_0x55ceeec82dd0;
interface_3_out_0x55ceeb214998 -> interface_2_in_0x55ceeb214998;
...

{
    ...
    interface_5_out_0x55ceeec91828;
    interface_5_out_0x55ceeec918a8;
    ...
    interface_6_out_0x55ceeec82fc8;
}
