...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x55e39eb54430 [label="H", shape=none];
    }
    {
        rank = same;
    ...
    interface_2_in_0x55e39eb54430 -> op_0x55e39eb54410 [label="H"];
    interface_2_in_0x55e3a880e020 -> interface_2_out_0x55e3a880e020 [label="N"];
    op_0x55e3a8936840 -> interface_2_out_0x55e3a880e098 [label="H"];
    interface_2_in_0x55e3a89345b0 -> interface_2_out_0x55e3a89345b0 [label="C_in"];
    op_0x55e3a8937b90 -> interface_2_out_0x55e3a8934650 [label="g^-2*k_1*C_out^2"];
    op_0x55e3a8937b90 -> interface_2_out_0x55e3a8935888 [label="g^-1*C_out"];
...
subgraph cluster_subgraph_3 {
    ...
    interface_3_out_0x55e39eb54430 [label="H", shape=none];
}
...
interface_3_out_0x55e39eb54430 -> interface_2_in_0x55e39eb54430;
...

{
    ...
    interface_3_out_0x55e39eb54430;
...
class kernel_generated_0(torch.nn.Module):
	...
	def forward(self, x):
		...
		# Perform contraction.
		t_3 = torch.einsum("mkoiln, jki -> mjoln", t_2, in_1)
