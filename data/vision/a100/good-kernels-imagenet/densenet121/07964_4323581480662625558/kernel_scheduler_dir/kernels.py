...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x560a2447e7a0 [label="H", shape=none];
    }
    {
        rank = same;
    ...
    op_0x560a2457b1c0 -> interface_2_out_0x560a2238a108 [label="g^-1*C_out"];
    interface_2_in_0x560a242c5b10 -> interface_2_out_0x560a242c5b10 [label="N"];
    op_0x560a21e8d400 -> interface_2_out_0x560a242c5b88 [label="H"];
    interface_2_in_0x560a242db900 -> interface_2_out_0x560a242db900 [label="C_in"];
    op_0x560a2457b1c0 -> interface_2_out_0x560a242db9a0 [label="g^-2*k_1*C_out^2"];
    interface_2_in_0x560a2447e6e0 -> interface_2_out_0x560a2447e6e0 [label="H"];
    interface_2_in_0x560a2447e7a0 -> op_0x560a2447e780 [label="H"];
    op_0x560a21e8d400 -> op_0x560a2457b1c0 [label="g^-3*k_1*C_out^3"];
}
...
subgraph cluster_subgraph_3 {
    ...
    interface_3_out_0x560a2447e7a0 [label="H", shape=none];
}
...
interface_3_out_0x560a2447e7a0 -> interface_2_in_0x560a2447e7a0;
...

{
    ...
    interface_3_out_0x560a2447e7a0;
...
class kernel_generated_0(torch.nn.Module):
	...
	def forward(self, x):
		...
		# Perform contraction.
		t_3 = torch.einsum("mklion, jki -> mjlon", t_2, in_1)
