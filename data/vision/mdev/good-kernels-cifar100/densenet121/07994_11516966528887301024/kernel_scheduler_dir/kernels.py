...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x560cbdcf2fb0 [label="H", shape=none];
    }
    {
        rank = same;
    ...
    interface_2_in_0x560cbdcf2fb0 -> op_0x560cbdcf2f90 [label="H"];
    op_0x560cbe2ef960 -> interface_2_out_0x560cbdd1aa88 [label="g^-1*C_out"];
    op_0x560cbdcf2f90 -> op_0x560cbdd1e600 [label="H"];
    interface_2_in_0x560cbdec1c00 -> interface_2_out_0x560cbdec1c00 [label="N"];
    op_0x560cbdd1e600 -> interface_2_out_0x560cbdec1c78 [label="H"];
    op_0x560cbdd1e600 -> op_0x560cbe2ef960 [label="g^-3*k_1*C_out^3"];
    interface_2_in_0x560cbe30f5a0 -> interface_2_out_0x560cbe30f5a0 [label="C_in"];
    op_0x560cbe2ef960 -> interface_2_out_0x560cbe30f640 [label="g^-2*k_1*C_out^2"];
}
...
subgraph cluster_subgraph_3 {
    ...
    interface_3_out_0x560cbdcf2fb0 [label="H", shape=none];
}
...
interface_3_out_0x560cbdcf2fb0 -> interface_2_in_0x560cbdcf2fb0;
...

{
    ...
    interface_3_out_0x560cbdcf2fb0;
...
class kernel_generated_0(torch.nn.Module):
	...
	def forward(self, x):
		...
		# Perform contraction.
		t_3 = torch.einsum("nmkilo, jki -> njmlo", t_2, in_1)
