...
subgraph cluster_subgraph_0 {
    ...
    subgraph cluster_subgraph_0_in_0 {
        ...
        interface_0_in_0x5590da8a9550 [label="H", shape=none];
        interface_0_in_0x5590da8ae4d8 [label="s", shape=none];
    ...
    }
    {
        ...
        interface_0_in_0x5590da8a9550;
        interface_0_in_0x5590da8ae4d8;
        interface_0_in_0x5590c9c88138;
    }
    // Op's.
    op_0x5590da8a94d0 [label="Shift"];
    op_0x5590da8a9530 [label="Shift"];
    ...
    op_0x5590da8a9c20 -> interface_0_out_0x5590c9c88110 [label="H"];
    interface_0_in_0x5590c9c88138 -> interface_0_out_0x5590c9c88138 [label="H"];
    op_0x5590da8ae480 -> op_0x5590da8a94d0 [label="s*H"];
    interface_0_in_0x5590da8a9550 -> op_0x5590da8a9530 [label="H"];
    op_0x5590da8a94d0 -> op_0x5590da8a9c20 [label="s*H"];
    op_0x5590da8a9530 -> op_0x5590da8ae480 [label="H"];
    interface_0_in_0x5590da8ae4d8 -> op_0x5590da8ae480 [label="s"];
...
subgraph cluster_subgraph_1 {
    ...
    subgraph cluster_subgraph_1_out {
        ...
        interface_1_out_0x5590da8a9550 [label="H", shape=none];
        interface_1_out_0x5590da8ae4d8 [label="s", shape=none];
    ...
    }
    {
        ...
        interface_1_out_0x5590da8a9550;
        interface_1_out_0x5590da8ae4d8;
    ...
    subgraph cluster_subgraph_1_in_0 {
        ...
        interface_1_in_0x5590da8a74a0 [label="C_out", shape=none];
        interface_1_in_0x5590da8a9550 [label="H", shape=none];
        interface_1_in_0x5590c9c88138 [label="H", shape=none];
    }
    // Input 1.
    subgraph cluster_subgraph_1_in_1 {
        label = "";
        interface_1_in_0x5590da8a74b8 [label="C_out", shape=none];
        interface_1_in_0x5590da8a7648 [label="s", shape=none];
    }
    {
        rank = same;
        interface_1_in_0x5590c9c880c0;
        interface_1_in_0x5590da8a74a0;
        interface_1_in_0x5590da8a9550;
        interface_1_in_0x5590c9c88138;
        interface_1_in_0x5590da8a74b8;
        interface_1_in_0x5590da8a7648;
    }
    // Op's.
    ...
    op_0x5590da8a7480 -> interface_1_out_0x5590c9c880e8 [label="C_out"];
    interface_1_in_0x5590c9c88138 -> interface_1_out_0x5590c9c88138 [label="H"];
    interface_1_in_0x5590da8a74a0 -> op_0x5590da8a7480 [label="C_out"];
    interface_1_in_0x5590da8a74b8 -> op_0x5590da8a7480 [label="C_out"];
    op_0x5590da8a7a78 -> op_0x5590da8a7610 [label="s"];
    interface_1_in_0x5590da8a7648 -> op_0x5590da8a7610 [label="s"];
    interface_1_in_0x5590da8a9550 -> interface_1_out_0x5590da8a9550 [label="H"];
    op_0x5590da8a7610 -> interface_1_out_0x5590da8ae4d8 [label="s"];
}
...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_out {
        ...
        interface_2_out_0x5590da8a74a0 [label="C_out", shape=none];
        interface_2_out_0x5590da8a9550 [label="H", shape=none];
    ...
    }
    {
        ...
        interface_2_out_0x5590da8a74a0;
        interface_2_out_0x5590da8a9550;
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x5590da8a76d0 [label="C_in", shape=none];
        interface_2_in_0x5590da8a9550 [label="H", shape=none];
        interface_2_in_0x5590da8a7720 [label="k_1", shape=none];
        interface_2_in_0x5590c9c88138 [label="H", shape=none];
    }
    // Input 1.
    subgraph cluster_subgraph_2_in_1 {
        label = "";
        interface_2_in_0x5590da8a7698 [label="C_out", shape=none];
        interface_2_in_0x5590da8a76e8 [label="C_in", shape=none];
        interface_2_in_0x5590da8a7738 [label="k_1", shape=none];
    }
    {
        rank = same;
        interface_2_in_0x5590c9c880c0;
        interface_2_in_0x5590da8a76d0;
        interface_2_in_0x5590da8a9550;
        interface_2_in_0x5590da8a7720;
        interface_2_in_0x5590c9c88138;
        interface_2_in_0x5590da8a7698;
        interface_2_in_0x5590da8a76e8;
        interface_2_in_0x5590da8a7738;
    }
    // Op's.
    ...
    op_0x5590da8a7660 -> interface_2_out_0x5590da8a74a0 [label="C_out"];
    op_0x5590da8a7a98 -> op_0x5590da8a7660 [label="C_out"];
    interface_2_in_0x5590da8a7698 -> op_0x5590da8a7660 [label="C_out"];
    interface_2_in_0x5590da8a76d0 -> op_0x5590da8a76b0 [label="C_in"];
    interface_2_in_0x5590da8a76e8 -> op_0x5590da8a76b0 [label="C_in"];
    interface_2_in_0x5590da8a7720 -> op_0x5590da8a7700 [label="k_1"];
    interface_2_in_0x5590da8a7738 -> op_0x5590da8a7700 [label="k_1"];
    interface_2_in_0x5590da8a9550 -> interface_2_out_0x5590da8a9550 [label="H"];
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_out {
        ...
        interface_3_out_0x5590da8a76d0 [label="C_in", shape=none];
        interface_3_out_0x5590da8a9550 [label="H", shape=none];
        interface_3_out_0x5590da8a7720 [label="k_1", shape=none];
        interface_3_out_0x5590c9c88138 [label="H", shape=none];
    }
    {
        rank = same;
        interface_3_out_0x5590c9c880c0;
        interface_3_out_0x5590da8a76d0;
        interface_3_out_0x5590da8a9550;
        interface_3_out_0x5590da8a7720;
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x5590da8a9550 [label="H", shape=none];
        interface_3_in_0x5590da8bf0e8 [label="H", shape=none];
    }
    {
        rank = same;
        interface_3_in_0x5590c9c880c0;
        interface_3_in_0x5590da8a76d0;
        interface_3_in_0x5590da8a9550;
        interface_3_in_0x5590da8bf0e8;
    }
    // Op's.
    op_0x5590da8bf0c0 [label="Unfold"];
    // Dimension's.
    interface_3_in_0x5590c9c880c0 -> interface_3_out_0x5590c9c880c0 [label="N"];
    op_0x5590da8bf0c0 -> interface_3_out_0x5590c9c88138 [label="H"];
    interface_3_in_0x5590da8a76d0 -> interface_3_out_0x5590da8a76d0 [label="C_in"];
    op_0x5590da8bf0c0 -> interface_3_out_0x5590da8a7720 [label="k_1"];
    interface_3_in_0x5590da8a9550 -> interface_3_out_0x5590da8a9550 [label="H"];
    interface_3_in_0x5590da8bf0e8 -> op_0x5590da8bf0c0 [label="H"];
}
...
subgraph cluster_subgraph_4 {
    ...
    interface_4_out_0x5590da8a9550 [label="H", shape=none];
    interface_4_out_0x5590da8bf0e8 [label="H", shape=none];
}

interface_4_out_0x5590c9c880c0 -> interface_3_in_0x5590c9c880c0;
interface_4_out_0x5590da8a76d0 -> interface_3_in_0x5590da8a76d0;
interface_4_out_0x5590da8a9550 -> interface_3_in_0x5590da8a9550;
interface_4_out_0x5590da8bf0e8 -> interface_3_in_0x5590da8bf0e8;

interface_3_out_0x5590c9c880c0 -> interface_2_in_0x5590c9c880c0;
interface_3_out_0x5590da8a76d0 -> interface_2_in_0x5590da8a76d0;
interface_3_out_0x5590da8a9550 -> interface_2_in_0x5590da8a9550;
interface_3_out_0x5590da8a7720 -> interface_2_in_0x5590da8a7720;
interface_3_out_0x5590c9c88138 -> interface_2_in_0x5590c9c88138;

// Input tensor.
subgraph cluster_subgraph_5 {
    label = "Input 2";
    interface_5_out_0x5590da8a7698 [label="C_out", shape=none];
    interface_5_out_0x5590da8a76e8 [label="C_in", shape=none];
    interface_5_out_0x5590da8a7738 [label="k_1", shape=none];
}

interface_5_out_0x5590da8a7698 -> interface_2_in_0x5590da8a7698;
interface_5_out_0x5590da8a76e8 -> interface_2_in_0x5590da8a76e8;
interface_5_out_0x5590da8a7738 -> interface_2_in_0x5590da8a7738;

interface_2_out_0x5590c9c880c0 -> interface_1_in_0x5590c9c880c0;
interface_2_out_0x5590da8a74a0 -> interface_1_in_0x5590da8a74a0;
interface_2_out_0x5590da8a9550 -> interface_1_in_0x5590da8a9550;
interface_2_out_0x5590c9c88138 -> interface_1_in_0x5590c9c88138;

// Input tensor.
subgraph cluster_subgraph_6 {
    label = "Input 1";
    interface_6_out_0x5590da8a74b8 [label="C_out", shape=none];
    interface_6_out_0x5590da8a7648 [label="s", shape=none];
}

interface_6_out_0x5590da8a74b8 -> interface_1_in_0x5590da8a74b8;
interface_6_out_0x5590da8a7648 -> interface_1_in_0x5590da8a7648;

interface_1_out_0x5590c9c880c0 -> interface_0_in_0x5590c9c880c0;
interface_1_out_0x5590c9c880e8 -> interface_0_in_0x5590c9c880e8;
interface_1_out_0x5590da8a9550 -> interface_0_in_0x5590da8a9550;
interface_1_out_0x5590da8ae4d8 -> interface_0_in_0x5590da8ae4d8;
...

{
    ...
    interface_4_out_0x5590da8a9550;
    interface_4_out_0x5590da8bf0e8;
    interface_6_out_0x5590da8a74b8;
    interface_6_out_0x5590da8a7648;
    interface_5_out_0x5590da8a7698;
    interface_5_out_0x5590da8a76e8;
    interface_5_out_0x5590da8a7738;
}
subgraph cluster_subgraph_output {
    label = "Output";
    interface_7_in_0x5590c9c880c0 [label="N", shape=none];
    interface_7_in_0x5590c9c880e8 [label="C_out", shape=none];
    interface_7_in_0x5590c9c88110 [label="H", shape=none];
    interface_7_in_0x5590c9c88138 [label="H", shape=none];
}
interface_0_out_0x5590c9c880c0 -> interface_7_in_0x5590c9c880c0;
interface_0_out_0x5590c9c880e8 -> interface_7_in_0x5590c9c880e8;
interface_0_out_0x5590c9c88110 -> interface_7_in_0x5590c9c88110;
interface_0_out_0x5590c9c88138 -> interface_7_in_0x5590c9c88138;
