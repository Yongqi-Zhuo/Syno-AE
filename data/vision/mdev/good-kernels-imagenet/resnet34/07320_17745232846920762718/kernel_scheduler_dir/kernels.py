...
subgraph cluster_subgraph_1 {
    ...
    subgraph cluster_subgraph_1_in_0 {
        ...
        interface_1_in_0x5590da8a9610 [label="H", shape=none];
    ...
    op_0x5590da8bf180 -> interface_1_out_0x5590da8a7860 [label="k_1"];
    interface_1_in_0x5590da8a9610 -> op_0x5590da8a95f0 [label="H"];
    op_0x5590da8a95f0 -> op_0x5590da8bf180 [label="H"];
}
...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_out {
        ...
        interface_2_out_0x5590da8a9610 [label="H", shape=none];
    ...
    }
    {
        ...
        interface_2_out_0x5590da8a9610;
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x5590da8a9610 [label="H", shape=none];
    ...
    interface_2_in_0x5590da8a7590 -> interface_2_out_0x5590da8a7590 [label="k_1"];
    ...
    interface_2_in_0x5590da8a9610 -> interface_2_out_0x5590da8a9610 [label="H"];
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_out {
        ...
        interface_3_out_0x5590da8a9610 [label="H", shape=none];
    ...
    }
    {
        ...
        interface_3_out_0x5590da8a9610;
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x5590da8a9610 [label="H", shape=none];
        interface_3_in_0x5590da8a7900 [label="k_1", shape=none];
    ...
    subgraph cluster_subgraph_3_in_1 {
        ...
        interface_3_in_0x5590da8a7918 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_3_in_0x5590da8a9610;
        interface_3_in_0x5590da8a7900;
        interface_3_in_0x5590c9c88138;
        interface_3_in_0x5590da8f9c28;
        interface_3_in_0x5590da8a7918;
        interface_3_in_0x5590da8a78c8;
    }
    // Op's.
    op_0x5590da8a7890 [label="Share"];
    op_0x5590da8a78e0 [label="Share"];
    ...
    op_0x5590da8a78e0 -> interface_3_out_0x5590da8a7590 [label="k_1"];
    ...
    interface_3_in_0x5590da8a7900 -> op_0x5590da8a78e0 [label="k_1"];
    interface_3_in_0x5590da8a7918 -> op_0x5590da8a78e0 [label="k_1"];
    interface_3_in_0x5590da8a9610 -> interface_3_out_0x5590da8a9610 [label="H"];
...
subgraph cluster_subgraph_4 {
    ...
    subgraph cluster_subgraph_4_out {
        ...
        interface_4_out_0x5590da8a9610 [label="H", shape=none];
        interface_4_out_0x5590da8a7900 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_4_out_0x5590da8a9610;
        interface_4_out_0x5590da8a7900;
    ...
    subgraph cluster_subgraph_4_in_0 {
        ...
        interface_4_in_0x5590da8a9610 [label="H", shape=none];
        interface_4_in_0x5590da8bf328 [label="H", shape=none];
    }
    {
        rank = same;
        interface_4_in_0x5590c9c880c0;
        interface_4_in_0x5590da8f9c10;
        interface_4_in_0x5590da8a9610;
        interface_4_in_0x5590da8bf328;
    }
    // Op's.
    op_0x5590da8bf300 [label="Unfold"];
    // Dimension's.
    interface_4_in_0x5590c9c880c0 -> interface_4_out_0x5590c9c880c0 [label="N"];
    op_0x5590da8bf300 -> interface_4_out_0x5590c9c88138 [label="H"];
    op_0x5590da8bf300 -> interface_4_out_0x5590da8a7900 [label="k_1"];
    interface_4_in_0x5590da8a9610 -> interface_4_out_0x5590da8a9610 [label="H"];
    interface_4_in_0x5590da8bf328 -> op_0x5590da8bf300 [label="H"];
...
subgraph cluster_subgraph_5 {
    ...
    interface_5_out_0x5590da8a9610 [label="H", shape=none];
    interface_5_out_0x5590da8bf328 [label="H", shape=none];
}

interface_5_out_0x5590c9c880c0 -> interface_4_in_0x5590c9c880c0;
interface_5_out_0x5590da8f9c10 -> interface_4_in_0x5590da8f9c10;
interface_5_out_0x5590da8a9610 -> interface_4_in_0x5590da8a9610;
interface_5_out_0x5590da8bf328 -> interface_4_in_0x5590da8bf328;

interface_4_out_0x5590c9c880c0 -> interface_3_in_0x5590c9c880c0;
interface_4_out_0x5590da8f9c10 -> interface_3_in_0x5590da8f9c10;
interface_4_out_0x5590da8a9610 -> interface_3_in_0x5590da8a9610;
interface_4_out_0x5590da8a7900 -> interface_3_in_0x5590da8a7900;
...
subgraph cluster_subgraph_6 {
    ...
    interface_6_out_0x5590da8a7918 [label="k_1", shape=none];
...
interface_6_out_0x5590da8a7918 -> interface_3_in_0x5590da8a7918;
...
interface_3_out_0x5590da8a9610 -> interface_2_in_0x5590da8a9610;
...
interface_2_out_0x5590da8a9610 -> interface_1_in_0x5590da8a9610;
...

{
    ...
    interface_5_out_0x5590da8a9610;
    interface_5_out_0x5590da8bf328;
    ...
    interface_6_out_0x5590da8a7918;
