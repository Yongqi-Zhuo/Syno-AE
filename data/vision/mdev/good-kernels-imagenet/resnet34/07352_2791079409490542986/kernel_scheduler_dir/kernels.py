...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x55dcd96807a8 [label="H", shape=none];
    ...
    interface_3_in_0x55dcd96807a8 -> interface_3_out_0x55dcd96807a8 [label="H"];
...
subgraph cluster_subgraph_4 {
    ...
    subgraph cluster_subgraph_4_out {
        ...
        interface_4_out_0x55dcd96807a8 [label="H", shape=none];
    ...
    }
    {
        ...
        interface_4_out_0x55dcd96807a8;
    ...
    subgraph cluster_subgraph_4_in_0 {
        ...
        interface_4_in_0x55dcd96807a8 [label="H", shape=none];
        interface_4_in_0x55dcd9719f68 [label="H", shape=none];
    }
    {
        rank = same;
        interface_4_in_0x55dcca2d4a60;
        interface_4_in_0x55dcd96b8e30;
        interface_4_in_0x55dcd96807a8;
        interface_4_in_0x55dcd9719f68;
    }
    // Op's.
    op_0x55dcd9719f40 [label="Unfold"];
    // Dimension's.
    interface_4_in_0x55dcca2d4a60 -> interface_4_out_0x55dcca2d4a60 [label="N"];
    op_0x55dcd9719f40 -> interface_4_out_0x55dcca2d4ad8 [label="H"];
    interface_4_in_0x55dcd96807a8 -> interface_4_out_0x55dcd96807a8 [label="H"];
    interface_4_in_0x55dcd96b8e30 -> interface_4_out_0x55dcd96b8e30 [label="C_in"];
    op_0x55dcd9719f40 -> interface_4_out_0x55dcd96b8e80 [label="k_1"];
    interface_4_in_0x55dcd9719f68 -> op_0x55dcd9719f40 [label="H"];
}
...
subgraph cluster_subgraph_5 {
    ...
    interface_5_out_0x55dcd96807a8 [label="H", shape=none];
    interface_5_out_0x55dcd9719f68 [label="H", shape=none];
}

interface_5_out_0x55dcca2d4a60 -> interface_4_in_0x55dcca2d4a60;
interface_5_out_0x55dcd96b8e30 -> interface_4_in_0x55dcd96b8e30;
interface_5_out_0x55dcd96807a8 -> interface_4_in_0x55dcd96807a8;
interface_5_out_0x55dcd9719f68 -> interface_4_in_0x55dcd9719f68;

interface_4_out_0x55dcca2d4a60 -> interface_3_in_0x55dcca2d4a60;
interface_4_out_0x55dcd96b8e30 -> interface_3_in_0x55dcd96b8e30;
interface_4_out_0x55dcd96807a8 -> interface_3_in_0x55dcd96807a8;
...

{
    ...
    interface_5_out_0x55dcd96807a8;
    interface_5_out_0x55dcd9719f68;
