...
subgraph cluster_subgraph_1 {
    ...
    subgraph cluster_subgraph_1_in_0 {
        ...
        interface_1_in_0x560f70f81080 [label="H", shape=none];
        interface_1_in_0x560f70f80290 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_1_in_0x560f70f81080;
        interface_1_in_0x560f70f80290;
        interface_1_in_0x560f6c4cbf48;
        interface_1_in_0x560f70f80420;
    }
    // Op's.
    op_0x560f70f81060 [label="Shift"];
    op_0x560f70f92f00 [label="Unfold"];
    // Dimension's.
    interface_1_in_0x560f6c4cbed0 -> interface_1_out_0x560f6c4cbed0 [label="N"];
    op_0x560f70f92f00 -> interface_1_out_0x560f6c4cbf20 [label="H"];
    interface_1_in_0x560f6c4cbf48 -> interface_1_out_0x560f6c4cbf48 [label="H"];
    interface_1_in_0x560f70f80290 -> interface_1_out_0x560f70f80290 [label="k_1"];
    op_0x560f70f92f00 -> interface_1_out_0x560f70f802e0 [label="k_1"];
    ...
    interface_1_in_0x560f70f81080 -> op_0x560f70f81060 [label="H"];
    op_0x560f70f81060 -> op_0x560f70f92f00 [label="H"];
}
...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_out {
        ...
        interface_2_out_0x560f70f81080 [label="H", shape=none];
        interface_2_out_0x560f70f80290 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_2_out_0x560f70f81080;
        interface_2_out_0x560f70f80290;
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x560f70f81080 [label="H", shape=none];
    ...
    interface_2_in_0x560f70f80290 -> interface_2_out_0x560f70f80290 [label="k_1"];
    ...
    interface_2_in_0x560f70f81080 -> interface_2_out_0x560f70f81080 [label="H"];
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_out {
        ...
        interface_3_out_0x560f70f81080 [label="H", shape=none];
    ...
    }
    {
        ...
        interface_3_out_0x560f70f81080;
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x560f70f81080 [label="H", shape=none];
        interface_3_in_0x560f70f804c0 [label="k_1", shape=none];
    ...
    subgraph cluster_subgraph_3_in_1 {
        ...
        interface_3_in_0x560f70f804d8 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_3_in_0x560f70f81080;
        interface_3_in_0x560f70f804c0;
        interface_3_in_0x560f6c4cbf48;
        interface_3_in_0x560f70f80618;
        interface_3_in_0x560f70f804d8;
        interface_3_in_0x560f70f80488;
    }
    // Op's.
    op_0x560f70f80450 [label="Share"];
    op_0x560f70f804a0 [label="Share"];
    ...
    op_0x560f70f804a0 -> interface_3_out_0x560f70f80290 [label="k_1"];
    ...
    interface_3_in_0x560f70f804c0 -> op_0x560f70f804a0 [label="k_1"];
    interface_3_in_0x560f70f804d8 -> op_0x560f70f804a0 [label="k_1"];
    interface_3_in_0x560f70f80600 -> op_0x560f70f805e0 [label="C_in"];
    interface_3_in_0x560f70f80618 -> op_0x560f70f805e0 [label="C_in"];
    interface_3_in_0x560f70f81080 -> interface_3_out_0x560f70f81080 [label="H"];
...
subgraph cluster_subgraph_4 {
    ...
    subgraph cluster_subgraph_4_out {
        ...
        interface_4_out_0x560f70f81080 [label="H", shape=none];
        interface_4_out_0x560f70f804c0 [label="k_1", shape=none];
    ...
    }
    {
        ...
        interface_4_out_0x560f70f81080;
        interface_4_out_0x560f70f804c0;
    ...
    subgraph cluster_subgraph_4_in_0 {
        ...
        interface_4_in_0x560f70f81080 [label="H", shape=none];
        interface_4_in_0x560f70f93028 [label="H", shape=none];
    }
    {
        rank = same;
        interface_4_in_0x560f6c4cbed0;
        interface_4_in_0x560f70f80600;
        interface_4_in_0x560f70f81080;
        interface_4_in_0x560f70f93028;
    }
    // Op's.
    op_0x560f70f93000 [label="Unfold"];
    // Dimension's.
    interface_4_in_0x560f6c4cbed0 -> interface_4_out_0x560f6c4cbed0 [label="N"];
    op_0x560f70f93000 -> interface_4_out_0x560f6c4cbf48 [label="H"];
    op_0x560f70f93000 -> interface_4_out_0x560f70f804c0 [label="k_1"];
    interface_4_in_0x560f70f80600 -> interface_4_out_0x560f70f80600 [label="C_in"];
    interface_4_in_0x560f70f81080 -> interface_4_out_0x560f70f81080 [label="H"];
    interface_4_in_0x560f70f93028 -> op_0x560f70f93000 [label="H"];
}
...
subgraph cluster_subgraph_5 {
    ...
    interface_5_out_0x560f70f81080 [label="H", shape=none];
    interface_5_out_0x560f70f93028 [label="H", shape=none];
}

interface_5_out_0x560f6c4cbed0 -> interface_4_in_0x560f6c4cbed0;
interface_5_out_0x560f70f80600 -> interface_4_in_0x560f70f80600;
interface_5_out_0x560f70f81080 -> interface_4_in_0x560f70f81080;
interface_5_out_0x560f70f93028 -> interface_4_in_0x560f70f93028;

interface_4_out_0x560f6c4cbed0 -> interface_3_in_0x560f6c4cbed0;
interface_4_out_0x560f70f80600 -> interface_3_in_0x560f70f80600;
interface_4_out_0x560f70f81080 -> interface_3_in_0x560f70f81080;
interface_4_out_0x560f70f804c0 -> interface_3_in_0x560f70f804c0;
...
subgraph cluster_subgraph_6 {
    ...
    interface_6_out_0x560f70f804d8 [label="k_1", shape=none];
...
interface_6_out_0x560f70f804d8 -> interface_3_in_0x560f70f804d8;
...
interface_3_out_0x560f70f81080 -> interface_2_in_0x560f70f81080;
...
interface_2_out_0x560f70f81080 -> interface_1_in_0x560f70f81080;
interface_2_out_0x560f70f80290 -> interface_1_in_0x560f70f80290;
...

{
    ...
    interface_5_out_0x560f70f81080;
    interface_5_out_0x560f70f93028;
    ...
    interface_6_out_0x560f70f804d8;
