...
subgraph cluster_subgraph_1 {
    ...
    subgraph cluster_subgraph_1_in_0 {
        ...
        interface_1_in_0x560f70f80f90 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_1_in_0x560f70f80f90;
    }
    // Op's.
    op_0x560f70f80f70 [label="Shift"];
    op_0x560f70f92dc0 [label="Unfold"];
    // Dimension's.
    ...
    op_0x560f70f92dc0 -> interface_1_out_0x560f6c4cbf48 [label="H"];
    ...
    op_0x560f70f92dc0 -> interface_1_out_0x560f70f802e0 [label="k_1"];
    interface_1_in_0x560f70f80f90 -> op_0x560f70f80f70 [label="H"];
    op_0x560f70f80f70 -> op_0x560f70f92dc0 [label="H"];
}
...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_out {
        ...
        interface_2_out_0x560f70f80f90 [label="H", shape=none];
    }
    {
        rank = same;
        ...
        interface_2_out_0x560f70f80f90;
    }
    // Input 0.
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x560f70f92da8 [label="H", shape=none];
        interface_2_in_0x560f70f80f90 [label="H", shape=none];
    }
    {
        rank = same;
        interface_2_in_0x560f6c4cbed0;
        interface_2_in_0x560f70f8b3d0;
        interface_2_in_0x560f70f92da8;
        interface_2_in_0x560f70f80f90;
    }
    // Op's.
    ...
    op_0x560f70f92d80 -> interface_2_out_0x560f70f80290 [label="k_1"];
    op_0x560f70f88d30 -> op_0x560f70f80ee0 [label="s*H"];
    interface_2_in_0x560f70f80f90 -> interface_2_out_0x560f70f80f90 [label="H"];
    ...
    interface_2_in_0x560f70f92da8 -> op_0x560f70f92d80 [label="H"];
...
subgraph cluster_subgraph_3 {
    ...
    interface_3_out_0x560f70f92da8 [label="H", shape=none];
    interface_3_out_0x560f70f80f90 [label="H", shape=none];
}

interface_3_out_0x560f6c4cbed0 -> interface_2_in_0x560f6c4cbed0;
interface_3_out_0x560f70f8b3d0 -> interface_2_in_0x560f70f8b3d0;
interface_3_out_0x560f70f92da8 -> interface_2_in_0x560f70f92da8;
interface_3_out_0x560f70f80f90 -> interface_2_in_0x560f70f80f90;
...
interface_2_out_0x560f70f80f90 -> interface_1_in_0x560f70f80f90;
...

{
    ...
    interface_3_out_0x560f70f92da8;
    interface_3_out_0x560f70f80f90;
