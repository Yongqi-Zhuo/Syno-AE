                    ...
                    for (int ri_2 = 0; ri_2 < k_1; ri_2++) {
                        ...
                        for (int ri_1 = 0; ri_1 < s^-1*C_in; ri_1++) {
                            ...
                            for (int ri_0 = 0; ri_0 < s; ri_0++) {
                                temp_ri_0 += in_0[i_0, ((i_3 * s + ri_0 + 1) % s*H % s) * s^-1*C_in + ri_1, restrict((i_2 + ri_3) - (k_1) / 2, 0, H), (restrict((((i_3 * s + ri_0 + 1) % s*H) / (s) + ri_2) - (k_1) / 2, 0, H) + 1) % H] * in_1[i_1, ri_3, ri_2, ri_1];
                            }
                            temp_ri_1 += temp_ri_0;
                        }
                        temp_ri_2 += temp_ri_1;
                ...
                for (int ri_2 = 0; ri_2 < C_out; ri_2++) {
                    ...
                    for (int ri_1 = 0; ri_1 < k_1; ri_1++) {
                        ...
                        for (int ri_0 = 0; ri_0 < k_1; ri_0++) {
                            temp_ri_0 += in_1[ri_2, ri_1, ri_0, i_1 % s^-1*C_in] * grad_out[i_0, ri_2, restrict(i_2 - ri_1 + (k_1) / 2, 0, H), (((restrict((i_3 - 1) % H - ri_0 + (k_1) / 2, 0, H) * s + i_1 / (s^-1*C_in)) - 1) % s*H) / (s)];
                        }
                        temp_ri_1 += temp_ri_0;
                    }
                    temp_ri_2 += temp_ri_1;
...
for (int i_0 = 0; i_0 < C_out; i_0++) {
    for (int i_1 = 0; i_1 < k_1; i_1++) {
        for (int i_2 = 0; i_2 < k_1; i_2++) {
            for (int i_3 = 0; i_3 < s^-1*C_in; i_3++) {
                float temp_ri_3 = 0;
                for (int ri_3 = 0; ri_3 < N; ri_3++) {
                    ...
                    for (int ri_2 = 0; ri_2 < H; ri_2++) {
                        ...
                        for (int ri_1 = 0; ri_1 < H; ri_1++) {
                            float temp_ri_0 = 0;
                            for (int ri_0 = 0; ri_0 < s; ri_0++) {
                                temp_ri_0 += in_0[ri_3, ri_0 * s^-1*C_in + i_3, ri_2, ri_1] * grad_out[ri_3, i_0, restrict(ri_2 - i_1 + (k_1) / 2, 0, H), (((restrict((ri_1 - 1) % H - i_2 + (k_1) / 2, 0, H) * s + ri_0) - 1) % s*H) / (s)];
                            }
                            temp_ri_1 += temp_ri_0;
                        }
                        temp_ri_2 += temp_ri_1;
