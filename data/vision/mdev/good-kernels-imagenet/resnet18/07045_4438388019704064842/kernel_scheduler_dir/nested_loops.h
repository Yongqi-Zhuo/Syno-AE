                        ...
                        for (int ri_2 = 0; ri_2 < k_1; ri_2++) {
                            ...
                            for (int ri_1 = 0; ri_1 < g^-1*s^-1*C_out; ri_1++) {
                                ...
                                for (int ri_0 = 0; ri_0 < g^-1*C_in; ri_0++) {
                                    temp_ri_0 += in_0[i_0, ri_4 * g^-1*C_in + ri_0, restrict((i_2 + ri_3) - (k_1) / 2, 0, H), restrict((i_3 + ri_2) - (k_1) / 2, 0, H)] * in_1[ri_4, ri_3, ri_2, i_1, ri_1] * in_2[ri_4 * g^-1*C_in + ri_0, ri_2, ri_1];
                                }
                                temp_ri_1 += temp_ri_0;
                            }
                            temp_ri_2 += temp_ri_1;
                    ...
                    for (int ri_2 = 0; ri_2 < k_1; ri_2++) {
                        ...
                        for (int ri_1 = 0; ri_1 < C_out; ri_1++) {
                            ...
                            for (int ri_0 = 0; ri_0 < g^-1*s^-1*C_out; ri_0++) {
                                temp_ri_0 += in_1[i_1 / (g^-1*C_in), ri_3, ri_2, ri_1, ri_0] * in_2[i_1, ri_2, ri_0] * grad_out[i_0, ri_1, restrict(i_2 - ri_3 + (k_1) / 2, 0, H), restrict(i_3 - ri_2 + (k_1) / 2, 0, H)];
                            }
                            temp_ri_1 += temp_ri_0;
                        }
                        temp_ri_2 += temp_ri_1;
                    ...
                    for (int ri_3 = 0; ri_3 < N; ri_3++) {
                        ...
                        for (int ri_2 = 0; ri_2 < H; ri_2++) {
                            ...
                            for (int ri_1 = 0; ri_1 < H; ri_1++) {
                                float temp_ri_0 = 0;
                                for (int ri_0 = 0; ri_0 < g^-1*C_in; ri_0++) {
                                    temp_ri_0 += in_0[ri_3, i_0 * g^-1*C_in + ri_0, ri_2, ri_1] * in_2[i_0 * g^-1*C_in + ri_0, i_2, i_4] * grad_out[ri_3, i_3, restrict(ri_2 - i_1 + (k_1) / 2, 0, H), restrict(ri_1 - i_2 + (k_1) / 2, 0, H)];
                                }
                                temp_ri_1 += temp_ri_0;
                            }
                            temp_ri_2 += temp_ri_1;
                    ...
                    for (int ri_2 = 0; ri_2 < N; ri_2++) {
                        ...
                        for (int ri_1 = 0; ri_1 < H; ri_1++) {
                            ...
                            for (int ri_0 = 0; ri_0 < H; ri_0++) {
                                temp_ri_0 += in_0[ri_2, i_0, ri_1, ri_0] * in_1[i_0 / (g^-1*C_in), ri_4, i_1, ri_3, i_2] * grad_out[ri_2, ri_3, restrict(ri_1 - ri_4 + (k_1) / 2, 0, H), restrict(ri_0 - i_1 + (k_1) / 2, 0, H)];
                            }
                            temp_ri_1 += temp_ri_0;
                        }
                        temp_ri_2 += temp_ri_1;
