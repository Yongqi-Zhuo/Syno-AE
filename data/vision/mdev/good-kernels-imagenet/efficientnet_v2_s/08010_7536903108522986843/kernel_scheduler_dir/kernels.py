...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_in_1 {
        ...
        interface_2_in_0x5596d7875318 [label="k_1^2", shape=none];
    }
    {
        rank = same;
    ...
    op_0x5596d78752e0 -> interface_2_out_0x5596d7875210 [label="k_1^2"];
    op_0x5596d7875678 -> op_0x5596d78752e0 [label="k_1^2"];
    interface_2_in_0x5596d7875318 -> op_0x5596d78752e0 [label="k_1^2"];
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x5596d78788c0 [label="C_in", shape=none];
        interface_3_in_0x5596d7875ea0 [label="H", shape=none];
        interface_3_in_0x5596d7879468 [label="H", shape=none];
    }
    {
        rank = same;
        interface_3_in_0x5596d7788c60;
        interface_3_in_0x5596d78788c0;
        interface_3_in_0x5596d7875ea0;
        interface_3_in_0x5596d7879468;
    }
    // Op's.
    ...
    op_0x5596d7878880 -> interface_3_out_0x5596d7875350 [label="s^-1*C_in"];
    op_0x5596d7879440 -> interface_3_out_0x5596d78753a0 [label="k_2"];
    interface_3_in_0x5596d7875ea0 -> interface_3_out_0x5596d7875ea0 [label="H"];
    op_0x5596d7878880 -> interface_3_out_0x5596d7877780 [label="s"];
    interface_3_in_0x5596d78788c0 -> op_0x5596d7878880 [label="C_in"];
    interface_3_in_0x5596d7879468 -> op_0x5596d7879440 [label="H"];
}
...
subgraph cluster_subgraph_4 {
    ...
    interface_4_out_0x5596d78788c0 [label="C_in", shape=none];
    interface_4_out_0x5596d7875ea0 [label="H", shape=none];
    interface_4_out_0x5596d7879468 [label="H", shape=none];
}

interface_4_out_0x5596d7788c60 -> interface_3_in_0x5596d7788c60;
interface_4_out_0x5596d78788c0 -> interface_3_in_0x5596d78788c0;
interface_4_out_0x5596d7875ea0 -> interface_3_in_0x5596d7875ea0;
interface_4_out_0x5596d7879468 -> interface_3_in_0x5596d7879468;
...
subgraph cluster_subgraph_5 {
    label = "Input 2";
    interface_5_out_0x5596d7875368 [label="s^-1*C_in", shape=none];
    interface_5_out_0x5596d78753b8 [label="k_2", shape=none];
    interface_5_out_0x5596d7875318 [label="k_1^2", shape=none];
}

interface_5_out_0x5596d7875368 -> interface_2_in_0x5596d7875368;
interface_5_out_0x5596d78753b8 -> interface_2_in_0x5596d78753b8;
interface_5_out_0x5596d7875318 -> interface_2_in_0x5596d7875318;
...

{
    ...
    interface_4_out_0x5596d78788c0;
    interface_4_out_0x5596d7875ea0;
    interface_4_out_0x5596d7879468;
    interface_6_out_0x5596d7875278;
    interface_6_out_0x5596d7875228;
    interface_5_out_0x5596d7875368;
    interface_5_out_0x5596d78753b8;
