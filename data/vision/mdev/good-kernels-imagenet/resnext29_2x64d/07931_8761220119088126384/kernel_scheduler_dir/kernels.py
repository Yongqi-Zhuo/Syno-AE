...
subgraph cluster_subgraph_1 {
    ...
    subgraph cluster_subgraph_1_in_0 {
        ...
        interface_1_in_0x55efa1d446a0 [label="g", shape=none];
    ...
    subgraph cluster_subgraph_1_in_1 {
        ...
        interface_1_in_0x55efa1d44708 [label="g^-1*C_out", shape=none];
    ...
    interface_1_in_0x55efa1d446a0 -> op_0x55efa1d44680 [label="g"];
    interface_1_in_0x55efa1d446b8 -> op_0x55efa1d44680 [label="g"];
    op_0x55efa1d449d8 -> op_0x55efa1d446d0 [label="g^-1*C_out"];
    interface_1_in_0x55efa1d44708 -> op_0x55efa1d446d0 [label="g^-1*C_out"];
    ...
    op_0x55efa1d446d0 -> interface_1_out_0x55efa1d46878 [label="g^-1*C_out"];
...
subgraph cluster_subgraph_2 {
    ...
    subgraph cluster_subgraph_2_out {
        ...
        interface_2_out_0x55efa1d446a0 [label="g", shape=none];
    ...
    }
    {
        ...
        interface_2_out_0x55efa1d446a0;
    ...
    subgraph cluster_subgraph_2_in_0 {
        ...
        interface_2_in_0x55efa1ddf1c0 [label="s^-1*C_in", shape=none];
    ...
    op_0x55efa1d54c00 [label="Unfold"];
    op_0x55efa1ddf180 [label="Split"];
    // Dimension's.
    ...
    op_0x55efa1ddf180 -> interface_2_out_0x55efa1d445b0 [label="g^-1*s^-1*C_in"];
    op_0x55efa1d54c00 -> interface_2_out_0x55efa1d44650 [label="k_1"];
    op_0x55efa1d54c00 -> interface_2_out_0x55efa1d446a0 [label="g"];
    ...
    op_0x55efa1ddf180 -> op_0x55efa1d54c00 [label="g"];
    interface_2_in_0x55efa1ddf1c0 -> op_0x55efa1ddf180 [label="s^-1*C_in"];
}
...
subgraph cluster_subgraph_3 {
    ...
    subgraph cluster_subgraph_3_in_0 {
        ...
        interface_3_in_0x55efa1ddf4e0 [label="C_in", shape=none];
        interface_3_in_0x55efa1d451e0 [label="H", shape=none];
        interface_3_in_0x55efa1d45240 [label="H", shape=none];
    }
    {
        rank = same;
        interface_3_in_0x55ef9e30f530;
        interface_3_in_0x55efa1ddf4e0;
        interface_3_in_0x55efa1d451e0;
        interface_3_in_0x55efa1d45240;
    }
    // Op's.
    op_0x55efa1ddf4a0 [label="Split"];
    // Dimension's.
    interface_3_in_0x55ef9e30f530 -> interface_3_out_0x55ef9e30f530 [label="N"];
    interface_3_in_0x55efa1d451e0 -> interface_3_out_0x55efa1d451e0 [label="H"];
    interface_3_in_0x55efa1d45240 -> interface_3_out_0x55efa1d45240 [label="H"];
    op_0x55efa1ddf4a0 -> interface_3_out_0x55efa1ddf1c0 [label="s^-1*C_in"];
    interface_3_in_0x55efa1ddf4e0 -> op_0x55efa1ddf4a0 [label="C_in"];
    op_0x55efa1ddf4a0 -> reduce_0x7f3dcc002e58 [label="s"];
}
...
subgraph cluster_subgraph_4 {
    ...
    interface_4_out_0x55efa1ddf4e0 [label="C_in", shape=none];
    interface_4_out_0x55efa1d451e0 [label="H", shape=none];
    interface_4_out_0x55efa1d45240 [label="H", shape=none];
}

interface_4_out_0x55ef9e30f530 -> interface_3_in_0x55ef9e30f530;
interface_4_out_0x55efa1ddf4e0 -> interface_3_in_0x55efa1ddf4e0;
interface_4_out_0x55efa1d451e0 -> interface_3_in_0x55efa1d451e0;
interface_4_out_0x55efa1d45240 -> interface_3_in_0x55efa1d45240;

interface_3_out_0x55ef9e30f530 -> interface_2_in_0x55ef9e30f530;
interface_3_out_0x55efa1ddf1c0 -> interface_2_in_0x55efa1ddf1c0;
...
interface_2_out_0x55efa1d446a0 -> interface_1_in_0x55efa1d446a0;
...
subgraph cluster_subgraph_5 {
    label = "Input 1";
    interface_5_out_0x55efa1d44668 [label="k_1", shape=none];
    interface_5_out_0x55efa1d445c8 [label="g^-1*s^-1*C_in", shape=none];
    interface_5_out_0x55efa1d446b8 [label="g", shape=none];
    interface_5_out_0x55efa1d44708 [label="g^-1*C_out", shape=none];
    interface_5_out_0x55efa1d444d8 [label="k_1", shape=none];
}

interface_5_out_0x55efa1d44668 -> interface_1_in_0x55efa1d44668;
interface_5_out_0x55efa1d445c8 -> interface_1_in_0x55efa1d445c8;
interface_5_out_0x55efa1d446b8 -> interface_1_in_0x55efa1d446b8;
interface_5_out_0x55efa1d44708 -> interface_1_in_0x55efa1d44708;
interface_5_out_0x55efa1d444d8 -> interface_1_in_0x55efa1d444d8;
...

{
    ...
    interface_4_out_0x55efa1ddf4e0;
    interface_4_out_0x55efa1d451e0;
    interface_4_out_0x55efa1d45240;
    interface_5_out_0x55efa1d44668;
    interface_5_out_0x55efa1d445c8;
    interface_5_out_0x55efa1d446b8;
    interface_5_out_0x55efa1d44708;
    interface_5_out_0x55efa1d444d8;
}
subgraph cluster_subgraph_output {
    label = "Output";
    interface_6_in_0x55ef9e30f530 [label="N", shape=none];
    interface_6_in_0x55ef9e30f558 [label="C_out", shape=none];
    interface_6_in_0x55ef9e30f580 [label="H", shape=none];
    interface_6_in_0x55ef9e30f5a8 [label="H", shape=none];
}
interface_0_out_0x55ef9e30f530 -> interface_6_in_0x55ef9e30f530;
interface_0_out_0x55ef9e30f558 -> interface_6_in_0x55ef9e30f558;
interface_0_out_0x55ef9e30f580 -> interface_6_in_0x55ef9e30f580;
interface_0_out_0x55ef9e30f5a8 -> interface_6_in_0x55ef9e30f5a8;
